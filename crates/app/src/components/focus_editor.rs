    ...
    rsx! {
        main { class: "main-pane",
            ...
            // ── sibling/depth navigation bar (RFC-020) ───────────────────
            {
                ...
                let commit_and_navigate = |nav: fn(&mut omriss_ui::EditorSession) -> bool,
                                            mut session: Signal<omriss_ui::EditorSession>,
                    ...
                    div { class: "sibling-nav",
                        button {
                            ...
                            onclick: move |_| commit_and_navigate(
                                omriss_ui::EditorSession::navigate_prev_sibling,
                                session, draft
                            ),
                        ...
                        button {
                            ...
                            onclick: move |_| commit_and_navigate(
                                omriss_ui::EditorSession::navigate_parent,
                                session, draft
                            ),
                        ...
                        button {
                            ...
                            onclick: move |_| commit_and_navigate(
                                omriss_ui::EditorSession::navigate_first_child,
                                session, draft
                            ),
                        ...
                        button {
                            ...
                            onclick: move |_| commit_and_navigate(
                                omriss_ui::EditorSession::navigate_next_sibling,
                                session, draft
                            ),
