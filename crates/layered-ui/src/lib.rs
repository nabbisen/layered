//! # layered-ui
//!
//! Renderer-independent GUI logic for the layered editor: editor sessions,
...
//! tests on any host; the desktop shell in `layered-desktop` wires these
//! types to Dioxus.
//!
//! ```
//! use layered_ui::{i18n::{t, Locale}, EditorSession};
//!
...
pub use layered_core::{MoveTarget, StructuralEditError};
