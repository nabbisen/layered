...
impl EditorSession {
    ...
    pub fn can_promote(&self) -> bool {
        self.view
            ...
            .and_then(|n| n.level)
            .map(|l| l != layerd_core::HeadingLevel::H1)
            .unwrap_or(false)
    }
    ...
    pub fn can_demote(&self) -> bool {
        self.view
            ...
            .and_then(|id| self.document.outline().node(id))
            .and_then(|n| n.level)
            .map(|l| l != layerd_core::HeadingLevel::H6)
            .unwrap_or(false)
    }
    ...
    pub fn promote_focused(&mut self) -> Result<EditResult, layerd_core::StructuralEditError> {
        let id = self
            .view
            .focused()
            .ok_or(layerd_core::StructuralEditError::CannotDeleteRoot)?;
    ...
    pub fn demote_focused(&mut self) -> Result<EditResult, layerd_core::StructuralEditError> {
        let id = self
            .view
            .focused()
            .ok_or(layerd_core::StructuralEditError::CannotDeleteRoot)?;
    ...
    pub fn move_focused(
        &mut self,
        target: layerd_core::MoveTarget,
    ) -> Result<EditResult, layerd_core::StructuralEditError> {
        let id = self
            .view
            .focused()
            .ok_or(layerd_core::StructuralEditError::StaleNode(
    ...
    pub fn split_focused(
        ...
        new_title: &str,
        new_level: layerd_core::HeadingLevel,
    ) -> Result<EditResult, layerd_core::StructuralEditError> {
        let id = self
            .view
            .focused()
    ...
    pub fn delete_focused(&mut self) -> Result<EditResult, layerd_core::StructuralEditError> {
        let id = self
            .view
            .focused()
            .ok_or(layerd_core::StructuralEditError::CannotDeleteRoot)?;
    ...
    pub fn merge_focused_up(&mut self) -> Result<EditResult, layerd_core::StructuralEditError> {
        let id = self
            .view
            .focused()
            .ok_or(layerd_core::StructuralEditError::NoAdjacentSibling)?;
        let rev = self.document.revision();
    ...
    pub fn move_focused_up(&mut self) -> Result<EditResult, layerd_core::StructuralEditError> {
        let id = self
            .view
            .focused()
            .ok_or(layerd_core::StructuralEditError::NoAdjacentSibling)?;
        ...
        let prev = info
            .prev_sibling
            .ok_or(layerd_core::StructuralEditError::NoAdjacentSibling)?;
        self.move_focused(layerd_core::MoveTarget::Before(prev))
    }

    /// Move the focused section down one position among its siblings (RFC-024).
    pub fn move_focused_down(&mut self) -> Result<EditResult, layerd_core::StructuralEditError> {
        let id = self
            .view
            .focused()
            .ok_or(layerd_core::StructuralEditError::NoAdjacentSibling)?;
        ...
        let next = info
            .next_sibling
            .ok_or(layerd_core::StructuralEditError::NoAdjacentSibling)?;
        self.move_focused(layerd_core::MoveTarget::After(next))
    }
