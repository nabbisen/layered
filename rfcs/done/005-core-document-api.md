...
Stabilize the minimum public API of `layerd-core` so UI and desktop crates can rely on a predictable document engine.
...
- `layerd-ui` can implement M2 screens using only public core API.
